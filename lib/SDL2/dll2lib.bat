...
REM Usage: dll2lib [32|64] some-file.dll out-file.lib
REM
REM Generates out-file.lib from some-file.dll, making an intermediate
...
REM 
REM Script adapted from https://gist.github.com/Trass3r/8d0232a66b098530d07b0e48df6ad5ef
REM (inspired by http://stackoverflow.com/questions/9946322/how-to-generate-an-import-library-lib-file-from-a-dll )
SETLOCAL
...
REM set lib_file=%dll_file_no_ext%.lib
...
lib /def:%def_file% /out:%out_file% /machine:%machine%
